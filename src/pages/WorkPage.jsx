        ...
        <div className="heading">
          ...
          <div className="DA">
            <div className="work-intro">
              ...
              <p>
                📊 Worked on multiple Data Analysis projects involving data
                cleaning, visualization, and insight generation using Excel,
                Power BI, and Python (Pandas, NumPy).
                <br />
                📈 Focused on turning raw data into actionable insights through
                dashboards, statistical analysis, and business-driven data
                storytelling.
              </p>
            </div>
          </div>
          ...
          <div className="work-intro">
            ...
            <p>
              ...
              (MongoDB, Express, React, Node.js) with features like
              authentication, CRUD operations, and responsive UI.
              <br />
              🚀 Focused on clean architecture (MVC pattern) and seamless
              frontend-backend integration to deliver efficient and
